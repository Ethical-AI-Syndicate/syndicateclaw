...
async def run_traffic() -> None:
    ...
    async with httpx.AsyncClient() as client:
        ...
        await req(
            client,
            "GET",
            "/api/v1/workflows/nonexistent-wf",
            actor="user:alice",
            token=alice_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-003/pause",
            actor="user:bob",
            token=bob_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-003/resume",
            actor="user:bob",
            token=bob_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-003/cancel",
            actor="user:bob",
            token=bob_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-002/pause",
            actor="user:bob",
            token=bob_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-003/replay",
            actor="user:bob",
            token=bob_token,
            body={},
        ...
        await req(
            client,
            "POST",
            "/api/v1/workflows/runs/run-002/replay",
            actor="user:bob",
            token=bob_token,
            body={},
        ...
        await req(
            client,
            "GET",
            "/api/v1/workflows/runs/run-002/nodes",
            actor="user:alice",
            token=alice_token,
        ...
        await req(
            client,
            "GET",
            "/api/v1/workflows/runs/run-002/timeline",
            actor="user:alice",
            token=alice_token,
        ...
        mem_id: str | None = r.json().get("id") if r.status_code == 201 else None
        ...
        await req(
            client,
            "GET",
            f"/api/v1/memory/traffic:ns/test-{_ts}",
            actor="user:alice",
            token=alice_token,
        ...
        r = await req(
            ...
            token=admin_token,
            body={
                "name": f"traffic-policy-{_ts}",
                "resource_type": "tool",
                "resource_pattern": "traffic_*",
                "effect": "ALLOW",
                "conditions": [],
                "priority": 5,
            },
        ...
        await req(
            client,
            "GET",
            "/api/v1/approvals/nonexistent-appr",
            actor="user:alice",
            token=alice_token,
        ...
        await req(
            client,
            "POST",
            "/api/v1/approvals/nonexistent-appr/approve",
            actor="user:alice",
            token=alice_token,
            body={},
        ...
        await req(
            client,
            "POST",
            "/api/v1/approvals/nonexistent-appr/reject",
            actor="user:alice",
            token=alice_token,
            body={},
        ...
        await req(
            client,
            "GET",
            "/api/v1/audit/trace/nonexistent-trace",
            actor="user:alice",
            token=alice_token,
        ...
        await req(
            client,
            "GET",
            "/api/v1/audit/runs/run-002/timeline",
            actor="user:alice",
            token=alice_token,
