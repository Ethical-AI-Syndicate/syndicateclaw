...
class TestPolicyConditionEvaluation:
    def test_policy_condition_eq(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_neq(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_in(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_gt_lt(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_matches_regex(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_nested_field(self) -> None:
        engine = _make_engine()
    ...
    def test_policy_condition_missing_field_returns_false(self) -> None:
        engine = _make_engine()
        cond = PolicyCondition(field="nonexistent", operator="eq", value="x")
        assert engine._evaluate_condition(cond, {}) is False

    def test_policy_condition_unknown_operator(self) -> None:
        engine = _make_engine()
