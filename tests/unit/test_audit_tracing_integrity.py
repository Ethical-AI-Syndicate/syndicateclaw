...
def test_setup_tracing_no_endpoint() -> None:
...
def test_setup_tracing_with_otlp_endpoint() -> None:
...
def test_create_span_yields_span() -> None:
...
def test_create_span_no_attributes() -> None:
    from syndicateclaw.audit.tracing import create_span, get_tracer
