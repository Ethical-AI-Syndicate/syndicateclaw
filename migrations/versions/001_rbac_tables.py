...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "team_id", sa.Text(), sa.ForeignKey("principals.id", ondelete="CASCADE"), nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "role_id", sa.Text(), sa.ForeignKey("roles.id", ondelete="CASCADE"), nullable=False
        ),
        sa.Column("scope_type", sa.Text(), nullable=False),
    ...
    op.create_index(
        "ix_impersonation_sessions_real", "impersonation_sessions", ["real_principal_id"]
    )
    op.create_index(
        "ix_impersonation_sessions_effective", "impersonation_sessions", ["effective_principal_id"]
    )
